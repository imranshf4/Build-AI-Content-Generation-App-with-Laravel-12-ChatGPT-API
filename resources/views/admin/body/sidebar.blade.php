...
<a href="index.html" class="logo">
    ...
    <li class="side-nav-item">
        <a href="{{ route('generate.main') }}" class="side-nav-link">
            <span class="menu-icon"><i class="ti ti-message"></i></span>
            <span class="menu-text"> Generate Content </span>
        </a>
    </li>

    <li class="side-nav-item">
        <a href="{{ route('generate.image') }}" class="side-nav-link">
            <span class="menu-icon"><i class="ti ti-calendar"></i></span>
            <span class="menu-text"> Generate Image </span>
        </a>
    </li>

    <li class="side-nav-item">
        <a href="{{ route('add.generate.image') }}" class="side-nav-link">
            <span class="menu-icon"><i class="ti ti-mailbox"></i></span>
            <span class="menu-text"> Add Generated Image </span>
        </a>
    </li>

    <li class="side-nav-item">
        <a href="{{ route('generate.audio') }}" class="side-nav-link">
            <span class="menu-icon"><i class="ti ti-calendar"></i></span>
            <span class="menu-text"> Generate Audio </span>
        </a>
    </li>
